...
(function (kotnShadowImageNames) {
    ...
    function itemBeforeSubmit(type) {
        if (type == 'edit' || type == 'create') {
            ...
            if (imageName && imageName != nlapiGetFieldValue('custitem_kotn_image_name'))
                nlapiSetFieldValue('custitem_kotn_image_name', imageName);
            var thumbnailName = nlapiGetFieldText('storedisplaythumbnail');
            if (thumbnailName && thumbnailName != nlapiGetFieldValue('custitem_kotn_thumbnail_name'))
    ...
    kotnShadowImageNames.itemAfterSubmit = itemAfterSubmit;
    /**
