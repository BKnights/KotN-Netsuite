...
module KOTNUtil {
	export function sendJSResponse(request : nlobjRequest, response : nlobjResponse, respObject : Object){
	...
	export function toJSON(target){return JSON.stringify(target);};
